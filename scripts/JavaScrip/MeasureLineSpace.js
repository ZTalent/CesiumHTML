class measureLineSpace {
	...
	getCatesian3FromPX(px) {
		...
		if(this.polyline_height==-1000)
		{
			var carto=new Cesium.Cartographic.fromDegrees(lon,lat);
			var height = this.viewer.scene.sampleHeight(carto);
			this.polyline_height = height + 0.05;
		}
		cartesian = Cesium.Cartesian3.fromDegrees(lon,lat,this.polyline_height);
		return cartesian;
	}
